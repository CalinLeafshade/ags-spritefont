 ...
 * Date: 18/04/2013                                        *
 *                                                         *
 * Description: An AGS Plugin to allow the use of          *
 * spritefonts                                             *
 *                                                         *
 ***********************************************************/
...
{
	engine = lpEngine;
	OutputDebugString(L"AGSSpriteFont: Init fixed width renderer");
	fontRenderer = new SpriteFontRenderer(engine);
	OutputDebugString(L"AGSSpriteFont: Init vari width renderer");
	...
	//register functions
	OutputDebugString(L"AGSSpriteFont: Register functions");
